...
To access a range of dates by year:
...
AR**I**MA does not assume stationarity. ARIMA will convert your data to stationary and then execute the function.
